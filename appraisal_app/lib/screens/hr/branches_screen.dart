...
class _BranchesScreenState extends State<BranchesScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<HrProvider>(context, listen: false).fetchBranches();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final branches = hrProvider.branches;
    ...
    return Scaffold(
      ...
      body: hrProvider.isLoadingBranches
          ...
          : branches.isEmpty
              ...
              : RefreshIndicator(
                  onRefresh: () => hrProvider.fetchBranches(),
